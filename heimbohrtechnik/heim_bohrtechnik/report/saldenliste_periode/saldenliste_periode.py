# Copyright (c) 2019-2025, libracore and contributors
...
def execute(filters=None):
    ...
    data = get_data(from_date, to_date, report_type, filters.get('company'))
...
@frappe.whitelist()
def get_data(from_date, to_date, report_type, company):   
    # prepare query
    sql_query = """
