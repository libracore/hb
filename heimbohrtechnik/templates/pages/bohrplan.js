...
function make() {
    ...
    console.log(frappe.render_template("heimbohrtechnik/heim_bohrtechnik/page/bohrplaner/calendar_grid.html", data))
...
function add_overlay(data) {
    ...
    var qty = data.dauer
    var width = 42 * qty;
    $(frappe.render_template('eimbohrtechnik/heim_bohrtechnik/page/bohrplaner/booking_overlay.html', {
        'width': width, 
